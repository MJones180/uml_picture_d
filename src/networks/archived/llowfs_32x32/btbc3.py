# Back to Back Convolution 3 (btbc3)
# Trainable parameters: 3,415,767
...
class Network(nn.Module):
    ...
    def __init__(self):
        ...
        self.flattened1 = nn.Linear(2304, 1024)
        self.dropout7 = nn.Dropout(0.4)
        self.flattened2 = nn.Linear(1024, 512)
        self.dropout8 = nn.Dropout(0.4)
        self.flattened3 = nn.Linear(512, 256)
        self.dropout9 = nn.Dropout(0.4)
        self.flattened4 = nn.Linear(256, 23)
