# `speedup_2` network [32x32] (copy of `best32_1_smaller_10`).
# Trainable parameters: 1,527,559
...
class Network(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv_block7 = _make_conv_block(128, 128, 3)
        self.maxpool4 = nn.MaxPool2d(2)
        self.dense_block1 = _make_dense_block(512, 2048, 0.3)
