# `best32_1_smaller_11` network [32x32] (copy of `best32_1_smaller_7`).
# Trainable parameters: 1,551,943
...
class Network(nn.Module):
    ...
    def __init__(self):
        ...
        self.dense_block1 = _make_dense_block(512, 1024, 0.3)
        self.dense_block2 = _make_dense_block(1024, 512, 0.3)
