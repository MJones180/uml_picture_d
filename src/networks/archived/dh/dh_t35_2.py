# `dh_t35_2` network { 2x59x59 -> 1000 }. (Based on `dh_t32_8_1000.py`)
# Trainable parameters: 87,417,320
...
class ResidualBlock(nn.Module):
    ...
    def __init__(self, channels):
        super().__init__()
        self.conv_block1 = _make_conv_block(channels, channels, False)
...
class Network(nn.Module):
    ...
    def __init__(self):
        ...
        # 15x15 -> 8x8
        self.conv_downsize_3 = _make_conv_block_and_downsize(1024, 2048)
        self.conv_residual_4 = ResidualBlock(2048)
        # 8x8 -> 1x1
