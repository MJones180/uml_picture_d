# `dh_t33_4_600` network { 2x59x59 -> 600 }. (Based on `dh_t32_8_600`)
# Trainable parameters: 131,084,376
...
class Network(nn.Module):
    ...
    def __init__(self):
        ...
        self.dense_block = _make_dense_block(2048, 2048)
        self.out_layer = nn.Linear(2048, 600)
