# `dh_t35_4` network { 2x59x59 -> 1000 }. (Based on `dh_t32_8_1000.py`)
# Trainable parameters: 149,365,736
...
class Network(nn.Module):
    ...
    def __init__(self):
        super().__init__()
        self.initial_conv_block = _make_conv_block(2, 512)
        self.conv_residual_1 = ResidualBlock(512)
        # 59x59 -> 30x30
        self.conv_downsize_1 = _make_conv_block_and_downsize(512, 512)
        self.conv_residual_2 = ResidualBlock(512)
        # 30x30 -> 15x15
        self.conv_downsize_2 = _make_conv_block_and_downsize(512, 512)
