# `dh_t37_5_full` network { 1000 -> 1512 }.
# Trainable parameters: 21,951,976
...
class Network(nn.Module):
    ...
    def __init__(self):
        ...
        self.res_block3 = BottleneckResidualBlock(2048, 1024)
        self.res_block4 = BottleneckResidualBlock(2048, 1024)
