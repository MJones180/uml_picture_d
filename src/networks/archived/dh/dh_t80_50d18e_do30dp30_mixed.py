# `dh_t80_50d18e_do30dp30_mixed` network { 756 -> 1000 }.
# Trainable parameters: 42,023,400
import numpy as np
import torch
...
class Network(nn.Module):
    ...
    def __init__(self):
        ...
        self.output_mixer = nn.Sequential(
            ...
            nn.LeakyReLU(LEAKY_RELU),
            nn.Linear(2 * OUTER_DIM, OUTER_DIM, bias=False),
            nn.BatchNorm1d(OUTER_DIM),
            nn.LeakyReLU(LEAKY_RELU),
        )
    ...
    def forward(self, x):
        ...
        return self.output(self.output_mixer(combined_features))
