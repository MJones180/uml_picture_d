# `dh_t78_h25do10dp30_h45do30dp30_cascaded_detached_v2` network { 1000 -> 1000 }
# Trainable parameters: 58,184,168
import numpy as np
import torch
...
class Network(nn.Module):
    ...
    def forward(self, x):
        ...
        x_and_head_1_input = torch.cat([x, head_1_features.detach()], dim=1)
