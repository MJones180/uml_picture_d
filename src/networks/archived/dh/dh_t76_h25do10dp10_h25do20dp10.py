# `dh_t76_h25do10dp10_h25do20dp10` network { 1000 -> 1000 }.
# Trainable parameters: 49,154,792
import numpy as np
import torch
...
class BottleneckResidualBlock(nn.Module):
    ...
    def __init__(self, inner_dim, gamma_init, dropout, drop_path_prob):
        super().__init__()
...
class Network(nn.Module):
    ...
    def __init__(self):
        ...
        self.head_1 = nn.Sequential(
            ...
            nn.BatchNorm1d(OUTER_DIM),
            *[
                BottleneckResidualBlock(HEAD_1_INNER_DIM, HEAD_1_GAMMA_INIT,
                                        HEAD_1_DROPOUT,
        ...
        self.head_2 = nn.Sequential(
            ...
            nn.BatchNorm1d(OUTER_DIM),
            *[
                BottleneckResidualBlock(HEAD_2_INNER_DIM, HEAD_2_GAMMA_INIT,
                                        HEAD_2_DROPOUT,
