# `dh_t32_8_1000_3d` network { 3x59x59 -> 1000 }. (Based on `dh_t31`)
# Trainable parameters: 138,149,480
...
class Network(nn.Module):
    ...
    def example_input():
        return torch.rand((1, 3, 59, 59))

    def __init__(self):
        super().__init__()
        self.initial_conv_block = _make_conv_block(3, 128, 3)
