# `dh_t80_50d18e_do30dp30_e50d` network { 756 -> 1000 }.
...
# Dropout rate to apply to the feature extraction
FEATURE_EXTRACTION_DROPOUT = 0.5
# Dropout rate
DROPOUT = 0.30
...
class Network(nn.Module):
    ...
    def __init__(self):
        ...
        self.features_for_end_dropout = nn.Dropout(FEATURE_EXTRACTION_DROPOUT)
    ...
    def forward(self, x):
        ...
        for i, block in enumerate(self.blocks):
            ...
            if i == (FEATURE_EXTRACTION_LAYER - 1):
                features_for_end = x
        features_for_end = self.features_for_end_dropout(features_for_end)
