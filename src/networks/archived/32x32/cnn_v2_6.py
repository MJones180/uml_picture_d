# Convolutional Neural Network V2 6 (cnn_v2_6)
# Trainable parameters: 3,186,423
...
class Network(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv_block2 = _make_conv_block(32, 64, 5)
        # 32x32 -> 16x16
        self.maxpool1 = nn.MaxPool2d(2)
        self.conv_block3 = _make_conv_block(64, 128, 5)
        # 16x16 -> 8x8
        self.maxpool2 = nn.MaxPool2d(2)
        self.conv_block4 = _make_conv_block(128, 256, 5)
        # 8x8 -> 4x4
