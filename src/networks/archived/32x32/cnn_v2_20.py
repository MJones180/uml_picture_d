# Convolutional Neural Network V2 20 (cnn_v2_20)
# Trainable parameters: 2,917,047
# Based on `cnn_v2_7` with a larger dense layer
...
class Network(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv_block5 = _make_conv_block(64, 128, 5)
        self.conv_block6 = _make_conv_block(128, 128, 5)
        # 8x8 -> 4x4
