# `dh_t10_half_300_2` network { 2x59x29 -> 300 }.
# Trainable parameters: 184,832,812
...
class Network(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv_block15 = _make_conv_block(1024, 2048, 3)
        self.conv_block16 = _make_conv_block(2048, 2048, 3)
        self.conv_block17 = _make_conv_block(2048, 2048, 3)
        self.conv_block18 = _make_conv_block(2048, 2048, 3)
        # 4x2 -> 1x1
        self.maxpool5 = nn.MaxPool2d(4, ceil_mode=True)
