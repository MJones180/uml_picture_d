# `dh_t10_half_300_6_3ch` network { 3x59x29 -> 300 }.
# Trainable parameters: 48,502,700
...
class Network(nn.Module):
    ...
    def example_input():
        return torch.rand((1, 3, 59, 29))

    def __init__(self):
        super().__init__()
        self.conv_block1 = _make_conv_block(3, 128, 3)
        ...
        # 8x4 -> 1x1
        self.avgpool1 = nn.AvgPool2d(8, ceil_mode=True)
