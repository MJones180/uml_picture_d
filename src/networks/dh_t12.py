# `dh_t12` network { 2x59x59 -> 1512 }, based on `dh_t10_avg`.
# Trainable parameters: 40,929,512
...
class Network(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv_block3 = _make_conv_block(128, 256, 3)
        self.conv_block4 = _make_conv_block(256, 256, 3)
        # 30x30 -> 15x15
        self.maxpool2 = nn.MaxPool2d(2)
        self.conv_block5 = _make_conv_block(256, 512, 3)
        self.conv_block6 = _make_conv_block(512, 512, 3)
        self.conv_block7 = _make_conv_block(512, 512, 3)
        # 15x15 -> 8x8
        self.maxpool3 = nn.MaxPool2d(2, ceil_mode=True)
        self.conv_block8 = _make_conv_block(512, 1024, 3)
        self.conv_block9 = _make_conv_block(1024, 1024, 3)
        self.conv_block10 = _make_conv_block(1024, 1024, 3)
        # 8x8 -> 1x1
