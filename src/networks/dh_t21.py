# `dh_t21` network { 2x59x59 -> 1512 }, based on `dh_t10_avg`.
# Trainable parameters: 94,322,408
...
class Network(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv_block4 = _make_conv_block(128, 128, 3)
        # 59x59 -> 30x30
        self.maxpool1 = nn.MaxPool2d(2, ceil_mode=True)
        self.conv_block5 = _make_conv_block(128, 256, 3)
        self.conv_block6 = _make_conv_block(256, 256, 3)
        self.conv_block7 = _make_conv_block(256, 256, 3)
        self.conv_block8 = _make_conv_block(256, 256, 3)
        # 30x30 -> 15x15
        self.maxpool2 = nn.MaxPool2d(2)
        self.conv_block9 = _make_conv_block(256, 512, 3)
        ...
        self.conv_block13 = _make_conv_block(512, 512, 3)
        # 15x15 -> 8x8
        self.maxpool3 = nn.MaxPool2d(2, ceil_mode=True)
        self.conv_block14 = _make_conv_block(512, 1024, 3)
        self.conv_block15 = _make_conv_block(1024, 1024, 3)
        self.conv_block16 = _make_conv_block(1024, 1024, 3)
        self.conv_block17 = _make_conv_block(1024, 1024, 3)
        self.conv_block18 = _make_conv_block(1024, 1024, 3)
        self.conv_block19 = _make_conv_block(1024, 1024, 3)
        self.conv_block20 = _make_conv_block(1024, 1024, 3)
        self.conv_block21 = _make_conv_block(1024, 1024, 3)
        # 8x8 -> 1x1
