# `dh_t39_6` network { 1000 -> 1000 }.
# Trainable parameters: 12,520,424
import torch
...
class Network(nn.Module):
    ...
    def __init__(self):
        ...
        self.res_block3 = BottleneckResidualBlock(HIDDEN_SIZE, BOTTLENECK_SIZE)
        self.res_block4 = BottleneckResidualBlock(HIDDEN_SIZE, BOTTLENECK_SIZE)
