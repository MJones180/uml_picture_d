# `speedup_7` network [32x32] (copy of `speedup_5`).
# Trainable parameters: 1,253,839
...
class Network(nn.Module):
    ...
    def __init__(self):
        ...
        self.dense_block1 = _make_dense_block(256, 512, 0.3)
        self.dense_block2 = _make_dense_block(512, 2048, 0.3)
