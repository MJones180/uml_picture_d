# Convolutional Neural Network V2 10 (cnn_v2_10)
# Trainable parameters: 1,469,239
# Based on `cnn_v2_1` with an additional dense layer at the end
...
class Network(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv_block4 = _make_conv_block(64, 128, 5)
        # 8x8 -> 4x4
