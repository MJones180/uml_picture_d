# `best32_1_smaller_1` network [32x32] (copy of the `best32_1` network).
# Trainable parameters: 321,975
...
class Network(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv_block10 = _make_conv_block(64, 64, 3)
        self.conv_block11 = _make_conv_block(64, 64, 3)
        self.conv_block12 = _make_conv_block(64, 64, 3)
        self.maxpool4 = nn.MaxPool2d(2)
        self.dense_block1 = _make_dense_block(256, 256, 0.3)
