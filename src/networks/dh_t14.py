# `dh_t14` network { 2x59x59 -> 1512 }, based on `dh_t10_avg`.
# Trainable parameters: 19,068,648
...
class Network(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv_block11 = _make_conv_block(256, 512, 3)
        self.conv_block12 = _make_conv_block(512, 512, 3)
        self.conv_block13 = _make_conv_block(512, 512, 3)
        self.conv_block14 = _make_conv_block(512, 512, 3)
        # 8x8 -> 1x1
        self.avgpool1 = nn.AvgPool2d(8)
        self.dense_block1 = _make_dense_block(512, 4096, 0.3)
