# `dh_t24_no_dropout` network { 2x59x59 -> 1512 }.
# Trainable parameters: 190,536,424
...
class Network(nn.Module):
    ...
    def __init__(self):
        ...
        # 59x59 -> 30x30
        self.conv_block5 = _make_conv_block_and_downsize(128, 256, 3)
        ...
        # 30x30 -> 15x15
        self.conv_block9 = _make_conv_block_and_downsize(256, 512, 3)
        ...
        # 15x15 -> 8x8
        self.conv_block13 = _make_conv_block_and_downsize(512, 1024, 3)
        ...
        # 8x8 -> 4x4
        self.conv_block17 = _make_conv_block_and_downsize(1024, 2048, 3)
        self.conv_block18 = _make_conv_block(2048, 2048, 3)
        self.conv_block19 = _make_conv_block(2048, 2048, 3)
        self.conv_block20 = _make_conv_block(2048, 2048, 3)
        # 4x4 -> 1x1
