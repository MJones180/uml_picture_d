# `dh_t15` network { 2x59x59 -> 1512 }, based on `dh_t10_avg`.
# Trainable parameters: 9,942,632
...
class Network(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv_block10 = _make_conv_block(128, 128, 3)
        # 15x15 -> 8x8
        self.maxpool3 = nn.MaxPool2d(2, ceil_mode=True)
        self.conv_block11 = _make_conv_block(128, 256, 3)
        self.conv_block12 = _make_conv_block(256, 256, 3)
        self.conv_block13 = _make_conv_block(256, 256, 3)
        self.conv_block14 = _make_conv_block(256, 256, 3)
        # 8x8 -> 1x1
        self.avgpool1 = nn.AvgPool2d(8)
        self.dense_block1 = _make_dense_block(256, 4096, 0.3)
