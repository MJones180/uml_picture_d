...
# Capture CNN: [V69a] `wavefront_capture_v4`
# Stabilization CNN: [V69b] `wavefront_stabilization_v4`
# RM: `fixed_40nm_pm`
# SCALING   Z2-3  Z4-8  Z9-24 | Capture CNN  Stabilization CNN    RM
#  4        2000    80     40 |         702                  2     2
#  3.5      1750    70     35 |        1458                 12    12
#  3        1500    60     30 |        2604                 20    20
#  2.5      1250    50     25 |        4157                 39    31
#  2        1000    40     20 |        4983                 89    76
#  1.5       750    30     15 |        5000                199   134
#  1.25      625    25   12.5 |        5000                259   174
#  1         500    20     10 |        5000                430   282
#  0.5       250    10      5 |        5000               1752  1156
#  0.25      125     5    2.5 |        5000               4775  4323
#  0.125    62.5   2.5   1.25 |        5000               5000  5000
#  0.0625  31.25  1.25  0.625 |        5000               5000  5000
RANGES = (500, 20, 10)
SCALE_FACTORS = [0.125, 0.25, 0.5, 1, 2, 3, 4]
Y_CAPTURE_NN = [5000, 5000, 5000, 5000, 4983, 2604, 702]
Y_STABIL_CNN = [5000, 4775, 1752, 430, 89, 20, 2]
