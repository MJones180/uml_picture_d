...
DM_COMPARISONS_P = f'{OUTPUT_P}/dm_comparisons'
EF_RECONSTRUCTIONS_P = f'{OUTPUT_P}/ef_reconstructions'
MODE_ANALYSIS_P = f'{OUTPUT_P}/mode_analysis'
...
LEARNING_RATES_F = 'learning_rates.csv'
...
OUTPUTS_LOG10 = 'outputs_log10'
OUTPUTS_Z_SCORE_MEAN = 'outputs_z_score_mean'
OUTPUTS_Z_SCORE_STD = 'outputs_z_score_std'
...
DM_ACTIVE_ROW_IDXS = lambda idx: f'dm_active_row_idxs_{idx}'  # noqa: E731
