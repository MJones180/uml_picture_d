...
- Obtained new PICTURE-D instrument data on March 24, 2026.
    - Data stored on the Samsung SSD under `llowfs_instrument_data/v7/llowfs_training_03_24_2026`.
...
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    mkdir inst_llowfs_v7_cap_bf
    # r_10_2_1_coeffs_100k
    cp lyt_alp_train_lac_20260324_175919_caldata.fits       inst_llowfs_v7_cap/0_data.fits
    cp lyt_alp_train_lac_20260324_175919_caldata_extra.fits inst_llowfs_v7_cap_bf/0_data.fits
    # r_500_20_10_coeffs_100k
    mv lyt_alp_train_lac_20260324_192925_caldata.fits       inst_llowfs_v7_cap/1_data.fits
    mv lyt_alp_train_lac_20260324_192925_caldata_extra.fits inst_llowfs_v7_cap_bf/1_data.fits
    # r_50_10_5_coeffs_100k
    mv lyt_alp_train_lac_20260324_193759_caldata.fits       inst_llowfs_v7_cap/2_data.fits
    mv lyt_alp_train_lac_20260324_193759_caldata_extra.fits inst_llowfs_v7_cap_bf/2_data.fits
    # r_15_5_2_coeffs_100k
    mv lyt_alp_train_lac_20260324_185044_caldata.fits       inst_llowfs_v7_cap/3_data.fits
    mv lyt_alp_train_lac_20260324_185044_caldata_extra.fits inst_llowfs_v7_cap_bf/3_data.fits
    # r_10_coeffs_100k
    mv lyt_alp_train_lac_20260324_180754_caldata.fits       inst_llowfs_v7_cap/4_data.fits
    mv lyt_alp_train_lac_20260324_180754_caldata_extra.fits inst_llowfs_v7_cap_bf/4_data.fits
    # f_50_2000_coeffs
    mv lyt_alp_train_lac_20260324_174150_caldata_extra.fits inst_llowfs_v7_cap_bf/5_data.fits

    # ---- Capture Data - Train Only ----
    mkdir inst_llowfs_v7_cap_to
    # f_50_2000_coeffs
    mv lyt_alp_train_lac_20260324_174150_caldata.fits       inst_llowfs_v7_cap_to/0_data.fits

    # ---- Stabilization Data ----
    mkdir inst_llowfs_v7_sta
    mkdir inst_llowfs_v7_sta_bf
    # r_10_2_1_coeffs_100k
    mv lyt_alp_train_lac_20260324_175919_caldata.fits       inst_llowfs_v7_sta/0_data.fits
    mv lyt_alp_train_lac_20260324_175919_caldata_extra.fits inst_llowfs_v7_sta_bf/0_data.fits
    # r_25_1_half_coeffs_100k
    mv lyt_alp_train_lac_20260324_190752_caldata.fits       inst_llowfs_v7_sta/1_data.fits
    mv lyt_alp_train_lac_20260324_190752_caldata_extra.fits inst_llowfs_v7_sta_bf/1_data.fits
    # r_15_2_1_coeffs_100k
    mv lyt_alp_train_lac_20260324_183337_caldata.fits       inst_llowfs_v7_sta/2_data.fits
    mv lyt_alp_train_lac_20260324_183337_caldata_extra.fits inst_llowfs_v7_sta_bf/2_data.fits
    # r_15_1_half_coeffs_100k
    mv lyt_alp_train_lac_20260324_182502_caldata.fits       inst_llowfs_v7_sta/3_data.fits
    mv lyt_alp_train_lac_20260324_182502_caldata_extra.fits inst_llowfs_v7_sta_bf/3_data.fits
    # r_10_1_half_coeffs_100k
    mv lyt_alp_train_lac_20260324_175045_caldata.fits       inst_llowfs_v7_sta/4_data.fits
    mv lyt_alp_train_lac_20260324_175045_caldata_extra.fits inst_llowfs_v7_sta_bf/4_data.fits
    # r_10_half_quarter_coeffs_100k
    mv lyt_alp_train_lac_20260324_181628_caldata.fits       inst_llowfs_v7_sta/5_data.fits
    mv lyt_alp_train_lac_20260324_181628_caldata_extra.fits inst_llowfs_v7_sta_bf/5_data.fits
    # r_half_quarter_fifth_coeffs_100k
    mv lyt_alp_train_lac_20260324_194634_caldata.fits       inst_llowfs_v7_sta/6_data.fits
    mv lyt_alp_train_lac_20260324_194634_caldata_extra.fits inst_llowfs_v7_sta_bf/6_data.fits
    # r_1_coeffs_100k
    mv lyt_alp_train_lac_20260324_185918_caldata.fits       inst_llowfs_v7_sta/7_data.fits
    mv lyt_alp_train_lac_20260324_185918_caldata_extra.fits inst_llowfs_v7_sta_bf/7_data.fits
    # r_2_coeffs_100k
    mv lyt_alp_train_lac_20260324_191627_caldata.fits       inst_llowfs_v7_sta/8_data.fits
    mv lyt_alp_train_lac_20260324_191627_caldata_extra.fits inst_llowfs_v7_sta_bf/8_data.fits
    # f_1_301_coeffs
    mv lyt_alp_train_lac_20260324_174101_caldata_extra.fits inst_llowfs_v7_sta_bf/9_data.fits

    # ---- Stabilization Data - Train Only ----
    mkdir inst_llowfs_v7_sta_to
    # f_1_301_coeffs
    mv lyt_alp_train_lac_20260324_174101_caldata.fits       inst_llowfs_v7_sta_to/0_data.fits

    # ---- Random 2nm Testing ----
    mkdir inst_llowfs_v7_tst_2nm_rnd
    mkdir inst_llowfs_v7_tst_2nm_rnd_bf
    # r_2_coeffs_50k
    mv lyt_alp_train_lac_20260324_192501_caldata.fits       inst_llowfs_v7_tst_2nm_rnd/0_data.fits
    mv lyt_alp_train_lac_20260324_192501_caldata_extra.fits inst_llowfs_v7_tst_2nm_rnd_bf/0_data.fits

    # ---- Fixed [-50, 50] nm Testing ----
    mkdir inst_llowfs_v7_tst_50nm_fix
    mkdir inst_llowfs_v7_tst_50nm_fix_bf
    # f_50_21_coeffs
    mv lyt_alp_train_lac_20260324_175011_caldata.fits       inst_llowfs_v7_tst_50nm_fix/0_data.fits
    mv lyt_alp_train_lac_20260324_175011_caldata_extra.fits inst_llowfs_v7_tst_50nm_fix_bf/0_data.fits

    # ---- Fixed [-1, 1] nm Testing ----
    mkdir inst_llowfs_v7_tst_1nm_fix
    mkdir inst_llowfs_v7_tst_1nm_fix_bf
    # f_1_21_coeffs
    mv lyt_alp_train_lac_20260324_174044_caldata.fits       inst_llowfs_v7_tst_1nm_fix/0_data.fits
    mv lyt_alp_train_lac_20260324_174044_caldata_extra.fits inst_llowfs_v7_tst_1nm_fix_bf/0_data.fits
